...
rule clean:
    shell: 'rm -r Data/*.geojson Resources/*.geojson Results/*.geojson Results/*.csv Plots/'
...
rule assign_country:
    ...
    script:
        "Scripts/assign_country_simple.py"
...
rule optimize_transport_and_conversion:
    ...
    script:
        'Scripts/optimize_transport_simple.py'
...
rule optimize_hydrogen_plant:
    ...
    script:
        'Scripts/optimize_hydrogen_plant_simple.py'
...
rule calculate_total_hydrogen_cost:
    ...
    script:
        'Scripts/total_hydrogen_cost_simple.py'
...
rule calculate_cost_components:
    ...
    script:
        'Scripts/costs_by_component_simple.py'
